...
r2d2 = Cohort.new(Date.new(2018,01,22))

@first_day = 2018,01,22

# puts r2d2.coffee_code_days

# puts r2d2.class_days

# puts r2d2.week_of(2)
#
# puts r2d2.weeks_of_cohort
# 
# puts r2d2.no_lecture_on(day.'saturday?')
